...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="post.php" class="nav-item nav-link">Blog Post</a>
                    <a href="login.php" class="nav-item nav-link">login</a>
                    <a href="signup.php" class="nav-item nav-link">Resister</a>
                ...
                <div class="col-lg-8">
                    ...
                    if (empty($posts)) {
                        ...
                        foreach ($posts as $post) {
                            ...
                            echo '<img class="img-fluid h-100" src="' . htmlspecialchars($post['image_url']) . '" style="object-fit: cover;">';
                            echo '<div class="overlay">';
                            echo '<div class="mb-1">';
                            echo '<a class="text-white" href="">Technology</a>';
                            echo '<span class="px-2 text-white">/</span>';
                            echo '</div>';
                            echo '<a class="h2 m-0 text-white font-weight-bold" href="">' . nl2br(htmlspecialchars($post['title'])) . '</a>';
                            echo ' </div>';
                            echo ' </div>';
                        }
                    }
    ...
    <div class="container-fluid py-3">
        <div class="container">
            ...
            if (empty($posts)) {
                ...
                echo '<div class="owl-carousel owl-carousel-2 carousel-item-4 position-relative">';
                foreach ($posts as $post) {
                    echo '<div class="position-relative overflow-hidden" style="height: 300px;">';
                    echo '<img class="img-fluid w-100 h-100" src="' . htmlspecialchars($post['image_url']) . '" style="object-fit: cover;">';
                    echo '<div class="overlay">';
                    echo '<div class="mb-1" style="font-size: 13px;">';
                    echo '<a class="text-white" href="">Technology</a>';
                    echo '<span class="px-1 text-white">/</span>';
                    echo '<a class="text-white" href="">January 01, 2045</a>';
                    echo '</div>';
                    echo '<a class="h4 m-0 text-white" href="post.php">' . nl2br(htmlspecialchars($post['title'])) . '</a>';
                    echo '</div>';
                    echo '</div>';
                }
            }
                ...
                <div class="col-lg-8">
                    <div class="row mb-3">
                        ...
                        if (empty($posts)) {
                            ...
                            $count = 0; // Initialize a counter to limit the number of cards
                            echo '<div class="col-lg-6">';
                            foreach ($posts as $post) {
                                if ($count >= 2) break; // Only show 2 cards
                                echo '<div class="position-relative mb-3">';
                                echo '<img class="img-fluid w-100" src="' . htmlspecialchars($post['image_url']) . '" height: 200px;style="object-fit: cover;">';
                                echo '<div class="overlay position-relative bg-light">';
                                echo '<div class="mb-2" style="font-size: 14px;">';
                                echo '<a href=""> Technology</a>';
                                echo '<span class="px-1">/</span>';
                                echo '<span>January 01, 2045</span>';
                                echo '</div>';
                                echo '<a class="h6" href="post.php">' . htmlspecialchars($post['title']) . '</a>';
                    ...
                    if (empty($posts)) {
                        ...
                        shuffle($posts); // Shuffle the array for randomness
                        $count = 0; // Initialize a counter to limit the number of cards
                        echo '<div class="col-lg-6">';
                        foreach ($posts as $post) {
                            if ($count >= 2) break; // Only show 2 cards
    ...
    <div class="container newsletter-wrapper">
        <div class="newsletter-box text-center">
            ...
            <p class="text-muted mb-4">Stay updated with the latest news and exclusive offers.</p>
            <form>
                <div class="mb-3">
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center">
            ...
            Designed by <a class="font-weight-bold" href="#">Vaibhav</a>
        </p>
    </div>
    <!-- Footer End -->
